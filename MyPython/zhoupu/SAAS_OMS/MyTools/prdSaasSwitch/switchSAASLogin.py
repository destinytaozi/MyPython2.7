...
class switchSAASLogin():
    ...
    def openSettingMenu(self,driver,distributionGet):
        # protocolElementPath=
        driver.find_element_by_xpath("/html/body/div[contains(@class,'fancybox-wrap fancybox-desktop')]/div[contains(@class,'fancybox-skin')]/a[contains(@title,'关闭')]").click() #关闭协议
        ActionChains(driver)
